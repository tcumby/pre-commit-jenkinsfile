...
Welcome to ``pre-commit-jenkinsfile`` contributor's guide.
...
If you experience bugs or general issues with ``pre-commit-jenkinsfile``, please have a look
...
You can help improve ``pre-commit-jenkinsfile`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pre-commit-jenkinsfile`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pre-commit-jenkinsfile``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pre-commit-jenkinsfile python=3 six virtualenv pytest pytest-cov
    conda activate pre-commit-jenkinsfile
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pre-commit-jenkinsfile.git
    cd pre-commit-jenkinsfile
...
#. Install |pre-commit|_::
   ...
   ``pre-commit-jenkinsfile`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pre-commit-jenkinsfile
.. _issue tracker: https://github.com/<USERNAME>/pre-commit-jenkinsfile/issues
.. <-- end -->
